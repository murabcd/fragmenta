		...
		<Card className="overflow-hidden">
			<CardHeader className="flex flex-row items-center space-x-4 p-4">
				...
				<div>
					...
					<CardDescription>
						Send your data straight to Google Sheets and sync all results as
						they come in.
					</CardDescription>
				</div>
			</CardHeader>
					...
					<AlertDialog>
						...
						<AlertDialogContent>
							<AlertDialogHeader>
								...
								<AlertDialogDescription>
									This action cannot be undone. This will remove the connection
									to Google Sheets and stop syncing your results.
								</AlertDialogDescription>
							</AlertDialogHeader>
							<AlertDialogFooter>
